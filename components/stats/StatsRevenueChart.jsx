        ...
        <View className="bg-white p-5 rounded-3xl shadow-sm mb-6 border border-gray-100">
            <View className="flex-row justify-between items-start mb-6">
                ...
                <View className="bg-green-100 px-3 py-1 rounded-lg">
                    <Text className="text-green-800 font-bold text-lg">23800 DH</Text>
                </View>
            </View>

            <View className="flex-row h-[180px]">
                <View className="justify-between h-[150px] mr-4">
                    <Text className="text-gray-400 text-xs">8640 DH</Text>
                    <Text className="text-gray-400 text-xs">7200 DH</Text>
                    <Text className="text-gray-400 text-xs">5400 DH</Text>
                    <Text className="text-gray-400 text-xs">3600 DH</Text>
                    <Text className="text-gray-400 text-xs">1800 DH</Text>
                    <Text className="text-gray-400 text-xs">0 DH</Text>
                </View>
